...
//add plugins in \assets\src\plugins
...
//include('../../plugins/custom-scrollbar-plugin-master/jquery.mCustomScrollbar.js')
//include('../../plugins/jquery-mousewheel/jquery.mousewheel.js')
//include('../../plugins/fullPage/jquery.fullpage.min.js')
...
var swiper = new Swiper(".categoties-slider", {
   spaceBetween: 15,
   slidesPerGroup: 3,
   breakpoints: {
      320: {
   ...
   navigation: {
     nextEl: ".categoties-slider-button-n",
     prevEl: ".categoties-slider-button-p",
   },
 });
 ...
 var swiper = new Swiper(".catalogue-slider", {
   ...
   navigation: {
     nextEl: ".catalogue-slider-button-n",
     prevEl: ".catalogue-slider-button-p",
   },
 });
 ...
 var swiper = new Swiper(".section-product-slider", {
  slidesPerGroup: 1,
  navigation: {
    nextEl: ".section-product-slider-button-n",
    prevEl: ".section-product-slider-button-p",
  },
});
 ...
 function changeCss () {
   ...
   var burger = document.getElementsByClassName("menu__icon")[0];
   var navElement = document.getElementById('intro');
   if(navElement){
     this.scrollY > navElement.clientHeight ?  burger.classList.add("-main-page-black") : burger.classList.remove("-main-page-black");
   }
 }
 
 window.addEventListener("scroll", changeCss , false);

 $(".--js-form-popups").click(function (e) {
  e.preventDefault();
  let popup = $(this).attr('href');
  //let dataEfekt = $(this).attr('data-effect');
  ...
  setTimeout(function() {
    var swiperGrid = new Swiper(".dimension-grid-slider-block", {
      spaceBetween: 0,
      slidesPerView: 1,
      breakpoints: {
        320: {
      ...
      pagination: {
        el: ".dimension-grid-slider-pagination",
        clickable: true,
      },
      thumbs: {
        swiper: galleryTop
    ...
    var galleryTop = new Swiper('.dimension-grid-slider-pag', {
      slidesPerView: 1,
      breakpoints: {
        320: {
          slidesPerView: 1,
    ...
    galleryTop.controller.control = swiperGrid;
    swiperGrid.controller.control = galleryTop; 
  }, 0); 
  return false;
});
